...
export function Login(props: PaperProps) {
  ...
  return (
    <div className="container w-[90%] lg:w-[50%] m-auto">
      <Paper m="lg" p="lg" radius="md" withBorder={true} {...props}>
        <Text className="mb-2" fw={500} size="lg">
          Olá, {type} com seu email
        </Text>
        ...
        <form onReset={form.onReset} onSubmit={form.onSubmit(handleSubmit, handleError)}>
          ...
          <Group justify="space-between" mt="xl">
            <Anchor c="dimmed" component="button" onClick={() => toggle()} size="xs" type="button">
